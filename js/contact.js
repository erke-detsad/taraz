const API_URL =
  "https://script.google.com/macros/s/AKfycbwrm6zHOUW6AXKNIy7yhue9yFLmKzwNrNtf0iIrVbmWkx04cM5Xq_j-rKbeQRklscCm/exec";
    ...
    fetch(API_URL, {
      ...
      .then((data) => {
        ...
        if (data && data.result === "success") {
          ...
          alert(
            "Қате: " +
              (data && data.error ? data.error : "Сервер дұрыс жауап бермеді."),
          );
          if (submitButton) {
            if (submitButton.tagName.toLowerCase() === "input")
              submitButton.value = originalBtnText;
